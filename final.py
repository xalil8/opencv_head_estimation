...
#cv2.resizeWindow('STACKED OUTPUT', 1, 1)
...
while True:
    ...
    if count > threshold:
        ...
        if not previous_count:
            print("APPEARED!")
        cv2.putText(frame,str("APPEARED"),(20,40),cv2.FONT_HERSHEY_COMPLEX,1,(0,255,0),2)
    else:
        shape_present = False
        if previous_count:
            print("DISAPPEARED!")
        cv2.putText(frame,str("DISAPPEARED"),(20,40),cv2.FONT_HERSHEY_COMPLEX,1,(0,0,255),2)
